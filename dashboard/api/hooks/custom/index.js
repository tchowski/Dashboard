      ...
      before: {
        '/*': {
          ...
          fn: async function (req, res, next) {
            ...
            var loggedInSocial = req.session.social;
            req.socialLog = req.session.social;
            res.locals.social_local = req.session.social;
            if (req.socialLog) {
              sails.log.warn("session social:" + req.socialLog);
              return next();
            }
