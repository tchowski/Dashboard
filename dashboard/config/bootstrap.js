...
module.exports.bootstrap = async function () {
  ...
  // Getting API currency 
  fetch("https://free.currconv.com/api/v7/currencies?apiKey=0e4502b69e971fff3acf").then(response => response.json())
  .then(data => {
    // console.log(data.results);
    sails.config.custom.currency = data.results;
  }).catch(err => sails.log.warn(err));
